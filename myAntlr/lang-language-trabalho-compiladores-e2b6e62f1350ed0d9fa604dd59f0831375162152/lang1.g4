...
decl: TYPE_INT ID TYPE_EQUAL exp TYPE_SEMI ;

fun: ID TYPE_OPEN_PARENTHESIS params? TYPE_CLOSE_PARENTHESIS (TYPE_COLON type)? TYPE_OPEN_BRACE cmd* TYPE_CLOSE_BRACE ;

params: ID TYPE_SRO type (TYPE_COMMA ID TYPE_SRO type)* ;

type: btype | type TYPE_OPEN_BRACKET TYPE_CLOSE_BRACKET ;

btype: TYPE_INT | TYPE_CHAR | TYPE_BOOL | TYPE_FLOAT | ID ;

stmt: cmd | decl ;

cmd: TYPE_OPEN_BRACE cmd* TYPE_CLOSE_BRACE 
   ...
   | ID TYPE_OPEN_PARENTHESIS exps? TYPE_CLOSE_PARENTHESIS TYPE_SEMI 
