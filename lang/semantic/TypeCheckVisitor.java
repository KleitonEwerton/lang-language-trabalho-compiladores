...
public class TypeCheckVisitor extends Visitor {
    ...
    public void visit(Prog p) {
        ...
        for (Func f : p.getFunctions()) {
            ...
            if (f.getParams() != null) {
                parameterType = new SType[f.getParams().getType().size()];
            ...
            LocalAmbiente<SType> novaFuncao = new LocalAmbiente<SType>(f.getId(),
                    new STyFun(parameterType, returnType, namesParameter, f.getId()));
        ...
        if (lvalue instanceof Identifier) {
            ...
            if (((ArrayAccess) lvalue).getLValue() != null
                ...
                // caso ja exista o array, verifica se o tipo casa com o esperado da atribuiçao
                    ...
                    a.getExp().accept(this); // Empilha o objeto da expressao => new int, new Ponto ou somente uma
                                             // variavel
            ...
            if (f.getFCallParams() != null) {
                ...
                for (Expression exp : f.getFCallParams().getExps()) {
                    ...
                    if (indiceParamPassado < tipoFuncao.getTypes().length) {
                        SType tipoParametro = tipoFuncao.getTypes()[indiceParamPassado]; // Tipo do parametro do campo
                                                                                         // da função
                        SType parametroPassado = stk.pop(); // parametro passado na chamada da funcao
        ...
        if (t.getType() != null) {
            ...
            if (t.getExp() == null) { // Tipo normal de data
                if (datas.get(t.getDataName()) != null) { // Tipo data existe
                    ...
                    logError.add(
                            "(" + getLineNumber() + ") Erro em (linha: " + t.getLine() + ", coluna: " + t.getColumn()
